              ...
              {!isLoading && currentMoney && (<TableHead>
                <TableRow>
                  ...
                  <TableCell className={classes.head} align="center"
                             onClick={() => sortByField('category')}>Category {fields.sortField === 'category' &&
                  <span>&#8645;</span>}</TableCell>
                  <TableCell className={classes.head} align="center"
                             onClick={() => sortByField('name')}>Name {fields.sortField === 'name' &&
                  <span>&#8645;</span>}</TableCell>
                  <TableCell className={classes.head} align="center"
                             onClick={() => sortByField('description')}>Description {fields.sortField === 'description' &&
                  <span>&#8645;</span>}</TableCell>
                  <TableCell className={classes.head} align="center"
                             onClick={() => sortByField('date')}>Date {fields.sortField === 'date' &&
                  <span>&#8645;</span>}</TableCell>
                  <TableCell className={classes.head} align="center"
                             onClick={() => sortByField('money')}>Money {fields.sortField === 'money' &&
                  <span>&#8645;</span>}</TableCell>
                ...
                {!isLoading && currentMoney?.map((item, i) => (
                  <TableRow className={classes.rows} key={item._id}>
                    ...
                    <TableCell className={classes.body}
                               align={"center"}>{new Date(item.date).toLocaleDateString()}</TableCell>
